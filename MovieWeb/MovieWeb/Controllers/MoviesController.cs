...
namespace MovieWeb.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Genre,Director,DateOfRelease")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Genre,Director,DateOfRelease")] Movie movie)
        {
            if (ModelState.IsValid)
            {
